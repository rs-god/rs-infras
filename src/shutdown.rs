...
/*
The smooth exit handling of the service is accomplished by receiving an exit semaphore.
When the exit semaphore is received, the program will wait for a period of time before exiting.
During this exit period, the program can perform some other cleanup operations.
 */
